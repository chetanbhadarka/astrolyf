      ...
      <ScrollView
        ...
        <View style={{paddingHorizontal: 10}}>
          <TouchableOpacity
            ...
            activeOpacity={0.9}
            onPress={() => props.navigation.navigate('UserWalletScreen')}>
            <Ionicons
              name="ios-wallet"
              size={32}
              color="#000"
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.9}
            onPress={() =>
              props.navigation.navigate('UserOrederHistoryScreen')
            }>
            <MaterialIcons
              name="history"
              size={32}
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.9}
            onPress={() => props.navigation.navigate('UserSupportChatScreen')}>
            <MaterialIcons
              name="support-agent"
              size={32}
              color="#000"
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              props.navigation.navigate('WebViewScreen', {
                link: 'https://www.website.com/contact-us/?source=SC&country=IN',
              })
            }>
            <MaterialIcons
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              props.navigation.navigate('WebViewScreen', {
                link: 'https://www.website.com/about-us/?source=SC&country=IN',
              })
            }>
            <Entypo
        ...
        <Text
          ...
          onPress={() =>
            props.navigation.navigate('WebViewScreen', {
              link: 'https://www.website.com/terms-and-conditions/?source=SC&country=IN',
            })
          }>
          {'Terms & Conditions'}
        </Text>
