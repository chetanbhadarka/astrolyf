...
export default function index(props) {
  ...
  return (
    <View style={{flex: 1}}>
      ...
      />
      <View
        style={{marginHorizontal: 14, paddingHorizontal: 20, borderRadius: 5}}>
        <Text
          style={{
            fontWeight: 'bold',
            fontSize: 20,
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.8}
          // onPress={() => dispatch(userActions.login({user: {role: 'admin'}}))}>
